...
### PLOTS ###
y_axis_labels = Csa_u_range
x_axis_labels = Csa_l_range
majorFormatter = FormatStrFormatter('%0.3f')
ax = sns.heatmap(gtol_vs_Hu_vs_Hl, xticklabels= x_axis_labels,
                 yticklabels=y_axis_labels)
ax.yaxis.set_major_formatter(majorFormatter)
plt.ylabel('heart to seat', fontsize = 12)
plt.xlabel('heart to head', fontsize = 12)
